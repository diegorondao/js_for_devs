...
//----------------------------------Função arrow------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
const saudacao = (pessoa) => console.log('Olá, ' + pessoa);
...
const turmaA = ['Victor', 'João', 'Maria', 'Camilla'];
const turmaB = ['Fernando', ...turmaA, 'Lorena', 'Miguel'];
console.log(turmaB); //Saída: array de string com 7 elementos
//Exemplo operador rest
function retornaArray(num, ...args) {
    console.log(num);
    return args;
}
